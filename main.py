...
ALGOS = [
    RCMEmbedder(block_len=1, log_level=logging.DEBUG, metric_sink=sink, allow_partial=True),
    RCMEmbedder(block_len=4, log_level=logging.DEBUG, metric_sink=sink, allow_partial=True),
    ITBEmbedder(log_level=logging.DEBUG, metric_sink=sink, allow_partial=True),
]
